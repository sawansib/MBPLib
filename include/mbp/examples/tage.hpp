...
namespace mbp {
  struct Tage : Predictor {
    ...
    Branch::PredictorSrc last_prediction = Branch::PredictorSrc::None;
    ...
    bool predict(uint64_t ip) override {
      ...
      if (m0 > 0 && m0IsWeak && meta[metahash()] >= 0)
        last_prediction = Branch::PredictorSrc::AltBank;
      else
        last_prediction = Branch::PredictorSrc::HitBank;
    ...
    Branch::PredictorSrc getPredictionType() override {
